...
import routesFinding.cluster.SectorCluster;
...
public class GreedySecterClusterInitSolution {
    ...
    public GreedySecterClusterInitSolution(Vehicle vehicle,
                                    String depot,
                                    ...
                                    List<ItemType> itemsCompatibleInfo, Location depotLocation) {
...
//        this.depotLocation = customerLocations.get(depot);
    ...
    public List<List<String>> generateRoutes(int sectorNum){
        ...
        List<List<String>> clusters = sectorCluster.clustering(sectorNum);
        int totalDistance = 0;
        int totalDuration = 0;
