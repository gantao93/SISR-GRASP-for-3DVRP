...
class AddContainerStackingSpec extends Specification {
    ...
    def "add to stack simple"() {
        core.base.container.Container con = Helper.getAddSpaceContainer(2,2,2)
        def i1 = Helper.getItem(1, 1, 1, 1, 1, 0)
        def i2 = Helper.getItem(1, 1, 1, 1, 10, 0)
        def pList = core.base.position.PositionService.findPositionCandidates(con, i1)
    ...
    def "Item can be placed on 2 other items"() {
        ...
        core.base.container.Container con = Helper.getAddSpaceContainer(1,10,2)
    ...
    def "add upper item beneath another upper item"() {
        ...
        when:
        def pos3 = Helper.findCand(core.base.position.PositionService.findPositionCandidates(con, i3), 1, 0, 1)
        Helper.add(con, pos3)
    ...
    def "add item in existing stack at lower level"() {
        ...
        con.parameter.add(core.base.container.ParameterType.GROUND_CONTACT_RULE, core.base.container.GroundContactRule.FREE)
