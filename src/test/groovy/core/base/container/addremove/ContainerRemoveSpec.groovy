...
class ContainerRemoveSpec extends Specification {
    ...
    def "remove an item - a valid item"() {
        core.base.container.Container con = Helper.getAddSpaceContainer2(3,3,2, Integer.MAX_VALUE)
    ...
    def "randomly add and remove items"() {
        core.base.container.Container con = Helper.getAddSpaceContainer2(10,10,4, Integer.MAX_VALUE)
