package core.base.container.addspace
...
class AddContainerBaseSpec extends Specification {
    ...
    def "find first position in empty container"() {
        ...
        def pList = core.base.position.PositionService.findPositionCandidates(con, i)
    ...
    def "find second position in container"() {
        ...
        Helper.add(con, core.base.position.PositionService.findPositionCandidates(con, i).get(0))

        when:
        def pList = core.base.position.PositionService.findPositionCandidates(con, i2)
    ...
    def "find and add third item in container"() {
        ...
        when:
        pList = core.base.position.PositionService.findPositionCandidates(con, i3)
    ...
    def "find and add forth item in container"() {
        ...
        Helper.add(con, core.base.position.PositionService.findPositionCandidates(con, i1).get(0))
        Helper.add(con, i2, 1, 0, 0)
        Helper.add(con, i3, 0, 1, 0)

        when:
        def pList = core.base.position.PositionService.findPositionCandidates(con, i4)
    ...
    def "find and add fifth item in container"() {
        ...
        when:
        def pList = core.base.position.PositionService.findPositionCandidates(con, i5)
    ...
    def "find and add sixth item in container"() {
        ...
        when:
        def pList = core.base.position.PositionService.findPositionCandidates(con, i6)
    ...
    def "do not find insert positions for too big items"() {
        ...
        when:
        def pList1 = core.base.position.PositionService.findPositionCandidates(con, i1)
        def pList2 = core.base.position.PositionService.findPositionCandidates(con, i2)
        def pList3 = core.base.position.PositionService.findPositionCandidates(con, i3)
        def pList4 = core.base.position.PositionService.findPositionCandidates(con, i4)
        def pList5 = core.base.position.PositionService.findPositionCandidates(con, i5)
    ...
    def "test full coverage of item ground"() {
        ...
        con.parameter.add(core.base.container.ParameterType.GROUND_CONTACT_RULE, core.base.container.GroundContactRule.COVERED)
        ...
        def pos4 = Helper.findCand(core.base.position.PositionService.findPositionCandidates(con, i4), 0, 0, 2, false)
        def i5 = Helper.getItem(3, 1, 1, 1, 100, 0)
        def pos5 = Helper.findCand(core.base.position.PositionService.findPositionCandidates(con, i5), 0, 0, 2, false)
        def i6 = Helper.getItem(4, 1, 1, 1, 100, 0)
        def pos6 = Helper.findCand(core.base.position.PositionService.findPositionCandidates(con, i6), 0, 0, 2, false)
    ...
    def "test horizontal projection of insert position"() {
        ...
        when:
        def pList = core.base.position.PositionService.findPositionCandidates(con, i3)
        then:
    ...
    def "test horizontal projection of insert position with space limiting box"() {
        ...
        con.getParameter().add(core.base.container.ParameterType.GROUND_CONTACT_RULE, core.base.container.GroundContactRule.FREE)
        ...
        when:
        def pList1 = core.base.position.PositionService.findPositionCandidates(con, i7)
        def pList2 = core.base.position.PositionService.findPositionCandidates(con, i8)
        def pList3 = core.base.position.PositionService.findPositionCandidates(con, i9)
        then:
