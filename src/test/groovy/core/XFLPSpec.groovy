...
class XFLPSpec extends Specification {
    ...
    def service = new GRASP()

    def setup() {
        service.setTypeOfOptimization(core.opt.GRASPOptType.FAST_FIXED_CONTAINER_PACKER)
    }
    ...
    def "error when no items inserted"() {
        ...
        then:
        thrown(core.exception.Exception)
    }
    ...
    def "invalid item data"() {
        ...
        0 | 1 | 1 | 1  | 1  || core.exception.Exception | 'Width of item must be greater 0'
        1 | 0 | 1 | 1  | 1  || core.exception.Exception | 'Length of item must be greater 0'
        1 | 1 | 0 | 1  | 1  || core.exception.Exception | 'Height of item must be greater 0'
        1 | 1 | 1 | -1 | 1  || core.exception.Exception | 'Immersive depth must be >= 0'
        1 | 1 | 1 | 1  | 1  || core.exception.Exception | 'Immersive depth must not lead to negative height'
        1 | 1 | 1 | 0  | 11 || core.exception.Exception | 'Item is too heavy for any container'
    }
